class PostsController < ApplicationController
  ...
  def update_percentages(current_percentages, option_id)
    ...
    def post_params
      params.require(:post).permit(:body, :post_id, :q1, :q2, :q1_args, :q2_args, :image_link, :video_link).merge(organization_id: session[:organization_id], topic_id: params[:topic_id])
    end
end
