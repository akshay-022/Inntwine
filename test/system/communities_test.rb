...
class CommunitiesTest < ApplicationSystemTestCase
  ...
  test "should create community" do
    ...
    fill_in "Moderators", with: @community.moderators_id
    fill_in "Name", with: @community.name
    fill_in "Organization", with: @community.organization_id
    fill_in "Privacy", with: @community.privacy_id
    fill_in "Topic", with: @community.topic_id
