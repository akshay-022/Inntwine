...
class ModeratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moderator" do
    assert_difference("Moderator.count") do
      post moderators_url, params: { moderator: { community_id: @moderator.community_id, user_id: @moderator.user_id } }
    end
  ...
  test "should update moderator" do
    patch moderator_url(@moderator), params: { moderator: { community_id: @moderator.community_id, user_id: @moderator.user_id } }
